(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[756],{50007:function(e,t,a){Promise.resolve().then(a.bind(a,67253))},67253:function(e,t,a){"use strict";a.r(t),a.d(t,{default:function(){return N}});var s=a(3827),r=a(49555),l=a(64090),n=a(10826),i=a(34059),d=a(26490),c=a(85497),o=a(18025),h=a(93151),u=a(80559),x=a(90684),p=a(97307),m=a(69475),f=a(57976),b=a(8792),y=a(47907),g=a(75504);let v={OFFER_ACCEPTED:"Offer Accepted",ONBOARDING:"Onboarding",HIRED:"Hired",CONVERTED:"Converted"},k={OFFER_ACCEPTED:"bg-amber-100 text-amber-700 border-amber-200",ONBOARDING:"bg-blue-100 text-blue-700 border-blue-200",HIRED:"bg-emerald-100 text-emerald-700 border-emerald-200",CONVERTED:"bg-purple-100 text-purple-700 border-purple-200"};function j(){let[e,t]=(0,l.useState)([]),[a,j]=(0,l.useState)(!0),[N,Z]=(0,l.useState)(""),[w,M]=(0,l.useState)(null),C=(0,y.useSearchParams)().get("candidate"),E=async()=>{try{let e=(await n.Z.get("/candidates")).data||[],a=e.filter(e=>"OFFER_SENT"===e.stage||"OFFER_ACCEPTED"===e.stage||"ONBOARDING"===e.stage||"HIRED"===e.stage);t(a.length>0?a:e)}catch(e){console.error("Failed to load onboarding candidates",e)}finally{j(!1)}},O=async e=>{if(confirm("Confirm conversion to employee? This will create an employee record.")){M(e);try{let t=await n.Z.post("/candidates/".concat(e,"/hire"));alert("✅ Successfully converted! Employee ID: ".concat(t.data.employee.employeeId)),await E(),window.location.href="/hrm/employees?view=".concat(t.data.employee.id)}catch(s){var t,a;let e=(null===(a=s.response)||void 0===a?void 0:null===(t=a.data)||void 0===t?void 0:t.message)||s.message||"Conversion failed";alert("❌ ".concat(e))}finally{M(null)}}};(0,l.useEffect)(()=>{E()},[]);let D=e.filter(e=>{let t=!C||e.id===C,a=!N||(e.name||"").toLowerCase().includes(N.toLowerCase())||(e.designation||e.position||"").toLowerCase().includes(N.toLowerCase());return t&&a}),z=[{label:"Ready to Onboard",value:e.filter(e=>"OFFER_ACCEPTED"===e.stage).length,color:"text-amber-600",bg:"bg-amber-50 border-amber-100"},{label:"In Progress",value:e.filter(e=>"ONBOARDING"===e.stage).length,color:"text-blue-600",bg:"bg-blue-50 border-blue-100"},{label:"Completed",value:e.filter(e=>"HIRED"===e.stage||"CONVERTED"===e.stage).length,color:"text-emerald-600",bg:"bg-emerald-50 border-emerald-100"},{label:"Total",value:e.length,color:"text-purple-600",bg:"bg-purple-50 border-purple-100"}];return a?(0,s.jsx)(r.Z,{title:"Onboarding",children:(0,s.jsx)("div",{className:"flex items-center justify-center min-h-[400px]",children:(0,s.jsx)("div",{className:"w-8 h-8 border-4 border-blue-500/30 border-t-blue-600 rounded-full animate-spin"})})}):(0,s.jsx)(r.Z,{title:"Onboarding",children:(0,s.jsxs)("div",{className:"space-y-6",children:[(0,s.jsxs)("div",{className:"flex items-center justify-between",children:[(0,s.jsxs)("div",{children:[(0,s.jsx)("h1",{className:"text-2xl font-black text-slate-800",children:"Onboarding"}),(0,s.jsx)("p",{className:"text-sm text-slate-500 mt-1",children:"Manage new hire onboarding processes"})]}),(0,s.jsxs)(b.default,{href:"/hrm/employees",className:"flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white rounded-xl text-sm font-bold hover:bg-blue-700 transition-all shadow-sm",children:[(0,s.jsx)(i.Z,{size:16})," Add New Employee"]})]}),(0,s.jsx)("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4",children:z.map((e,t)=>(0,s.jsxs)("div",{className:(0,g.Z)("rounded-2xl border p-5 flex flex-col items-center justify-center text-center",e.bg),children:[(0,s.jsx)("span",{className:(0,g.Z)("text-3xl font-black",e.color),children:e.value}),(0,s.jsx)("span",{className:"text-xs font-bold text-slate-500 uppercase mt-1 tracking-widest",children:e.label})]},t))}),(0,s.jsxs)("div",{className:"bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden",children:[(0,s.jsx)("div",{className:"p-6 border-b border-slate-100",children:(0,s.jsxs)("div",{className:"flex items-center gap-4",children:[(0,s.jsxs)("div",{className:"relative flex-1",children:[(0,s.jsx)(i.Z,{size:16,className:"absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400"}),(0,s.jsx)("input",{className:"w-full pl-10 pr-4 py-2.5 rounded-lg border border-slate-200 text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none",placeholder:"Search by name or designation...",value:N,onChange:e=>Z(e.target.value)})]}),C&&(0,s.jsxs)(b.default,{href:"/hrm/onboarding",className:"px-4 py-2 bg-amber-50 text-amber-700 border border-amber-200 rounded-lg text-xs font-bold hover:bg-amber-100 transition-all flex items-center gap-2",children:[(0,s.jsx)(d.Z,{size:14})," Showing Target Only",(0,s.jsx)("span",{className:"opacity-50 font-normal underline ml-1",children:"Clear"})]})]})}),(0,s.jsx)("div",{className:"divide-y divide-slate-100",children:0===D.length?(0,s.jsxs)("div",{className:"p-12 text-center",children:[(0,s.jsx)("div",{className:"w-16 h-16 rounded-2xl bg-blue-50 flex items-center justify-center mx-auto mb-4",children:(0,s.jsx)(c.Z,{size:28,className:"text-blue-400"})}),(0,s.jsx)("h3",{className:"font-black text-slate-700 text-lg mb-1",children:"No candidates ready to onboard"}),(0,s.jsx)("p",{className:"text-sm text-slate-400",children:"Candidates who have accepted offers will appear here."}),(0,s.jsxs)(b.default,{href:"/hrm/employees",className:"inline-flex items-center gap-2 mt-5 px-5 py-2.5 bg-blue-600 text-white rounded-xl text-sm font-bold hover:bg-blue-700 transition-all",children:["Add Candidate ",(0,s.jsx)(o.Z,{size:14})]})]}):D.map(e=>(0,s.jsxs)("div",{className:"p-5 flex items-center justify-between hover:bg-slate-50 transition-colors",children:[(0,s.jsxs)("div",{className:"flex items-center gap-4",children:[(0,s.jsx)("div",{className:"w-11 h-11 rounded-full bg-blue-600 text-white flex items-center justify-center font-black text-sm shadow-sm shrink-0",children:(e.name.replace(/^(Mr\.|Ms\.|Mrs\.|Dr\.|Mr|Ms|Mrs|Dr) /i,"")||"?")[0].toUpperCase()}),(0,s.jsxs)("div",{children:[(0,s.jsx)("div",{className:"font-black text-slate-800 text-sm",children:e.name.replace(/^(Mr\.|Ms\.|Mrs\.|Dr\.|Mr|Ms|Mrs|Dr) /i,"")}),(0,s.jsxs)("div",{className:"text-[11px] text-slate-500 flex items-center gap-3 mt-0.5 flex-wrap",children:[(e.designation||e.position)&&(0,s.jsxs)("span",{className:"flex items-center gap-1",children:[(0,s.jsx)(h.Z,{size:10}),e.designation||e.position]}),e.department&&(0,s.jsxs)("span",{className:"flex items-center gap-1",children:[(0,s.jsx)(u.Z,{size:10}),e.department]}),e.email&&(0,s.jsxs)("span",{className:"flex items-center gap-1",children:[(0,s.jsx)(x.Z,{size:10}),e.email]}),e.joiningDate&&(0,s.jsxs)("span",{className:"flex items-center gap-1",children:[(0,s.jsx)(p.Z,{size:10}),"Joining:"," ",new Date(e.joiningDate).toLocaleDateString("en-IN")]})]})]})]}),(0,s.jsxs)("div",{className:"flex items-center gap-3",children:[e.stage&&(0,s.jsx)("span",{className:(0,g.Z)("text-[10px] font-bold uppercase tracking-widest px-2.5 py-1 rounded-lg border",k[e.stage]||"bg-slate-100 text-slate-600 border-slate-200"),children:v[e.stage]||e.stage}),(0,s.jsxs)(b.default,{href:"/hrm/emp-documents/offer-letter?type=OFFER&targetId=".concat(e.id,"&targetType=CANDIDATE"),className:"flex items-center gap-1.5 px-3 py-2 border border-blue-200 text-blue-600 rounded-lg text-[11px] font-bold hover:bg-blue-50 transition-all",children:[(0,s.jsx)(m.Z,{size:12})," Offer Letter"]}),(0,s.jsxs)("button",{onClick:()=>O(e.id),disabled:w===e.id,className:"flex items-center gap-1.5 px-3 py-2 bg-blue-600 text-white rounded-lg text-[11px] font-bold hover:bg-blue-700 transition-all disabled:opacity-50",children:[w===e.id?(0,s.jsx)("div",{className:"w-3 h-3 border-2 border-white/30 border-t-white rounded-full animate-spin"}):(0,s.jsx)(f.Z,{size:12}),"Convert to Employee"]})]})]},e.id))})]}),(0,s.jsxs)("div",{className:"bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-6 text-white shadow-lg",children:[(0,s.jsx)("h3",{className:"font-black text-lg mb-4",children:"Onboarding Checklist"}),(0,s.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:[{step:"01",title:"Send Offer Letter",desc:"Generate and share the official offer letter with the candidate.",icon:(0,s.jsx)(m.Z,{size:20})},{step:"02",title:"Collect Documents",desc:"Gather necessary documents: ID proof, address proof, certificates.",icon:(0,s.jsx)(f.Z,{size:20})},{step:"03",title:"Convert to Employee",desc:"Once all docs are verified, convert the candidate to an employee.",icon:(0,s.jsx)(c.Z,{size:20})}].map((e,t)=>(0,s.jsxs)("div",{className:"bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20",children:[(0,s.jsxs)("div",{className:"flex items-center gap-3 mb-2",children:[(0,s.jsx)("div",{className:"w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center",children:e.icon}),(0,s.jsxs)("span",{className:"text-xs font-bold text-blue-200 uppercase tracking-widest",children:["Step ",e.step]})]}),(0,s.jsx)("div",{className:"font-black text-white text-sm",children:e.title}),(0,s.jsx)("div",{className:"text-xs text-blue-200 mt-1 leading-relaxed",children:e.desc})]},t))})]})]})})}function N(){return(0,s.jsx)(l.Suspense,{fallback:(0,s.jsx)("div",{children:"Loading..."}),children:(0,s.jsx)(j,{})})}},18025:function(e,t,a){"use strict";a.d(t,{Z:function(){return s}});/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */let s=(0,a(87461).Z)("FileText",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]])},5423:function(e,t,a){"use strict";a.d(t,{Z:function(){return s}});/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */let s=(0,a(87461).Z)("LogOut",[["path",{d:"M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4",key:"1uf3rs"}],["polyline",{points:"16 17 21 12 16 7",key:"1gabdz"}],["line",{x1:"21",x2:"9",y1:"12",y2:"12",key:"1uyos4"}]])},29910:function(e,t,a){"use strict";a.d(t,{Z:function(){return s}});/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */let s=(0,a(87461).Z)("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]])}},function(e){e.O(0,[29,852,555,971,69,744],function(){return e(e.s=50007)}),_N_E=e.O()}]);