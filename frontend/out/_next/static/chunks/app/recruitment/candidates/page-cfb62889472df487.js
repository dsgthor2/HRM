(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[382],{45271:function(e,t,a){Promise.resolve().then(a.bind(a,61589))},61589:function(e,t,a){"use strict";a.r(t),a.d(t,{default:function(){return m}});var s=a(3827),n=a(30394),l=a(64090),i=a(10826),r=a(70094),c=a(85497),d=a(37841),o=a(77731),u=a(52235);let h=["APPLIED","SCREENING","INTERVIEW","OFFER_SENT","OFFER_ACCEPTED","ONBOARDING","HIRED","REJECTED"],x={APPLIED:"badge-gray",SCREENING:"badge-yellow",INTERVIEW:"badge-blue",OFFER_SENT:"badge-navy",OFFER_ACCEPTED:"badge-amber",ONBOARDING:"badge-blue",HIRED:"badge-green",REJECTED:"badge-red"},p={name:"",email:"",phone:"",position:"",department:"",stage:"APPLIED",expectedCTC:"",notes:"",interviewDate:""};function m(){let[e,t]=(0,l.useState)([]),[a,m]=(0,l.useState)(""),[y,v]=(0,l.useState)(""),[g,b]=(0,l.useState)(!1),[f,j]=(0,l.useState)({...p}),[N,k]=(0,l.useState)(!1),[C,Z]=(0,l.useState)(null),[w,E]=(0,l.useState)(null),M=()=>{let e=new URLSearchParams;a&&e.set("stage",a),y&&e.set("search",y),i.Z.get("/candidates?".concat(e)).then(e=>t(e.data)).catch(()=>{})};(0,l.useEffect)(()=>{M()},[a,y]);let D=async e=>{e.preventDefault(),k(!0);try{let e={...f};e.expectedCTC&&(e.expectedCTC=parseFloat(e.expectedCTC)||0),w?await i.Z.put("/candidates/".concat(w),e):await i.Z.post("/candidates",e),b(!1),E(null),j({...p}),M()}catch(e){var t,a;alert((null===(a=e.response)||void 0===a?void 0:null===(t=a.data)||void 0===t?void 0:t.error)||"Failed to save candidate")}finally{k(!1)}},S=e=>{j({name:e.name,email:e.email||"",phone:e.phone||"",position:e.designation||e.position||"",department:e.department||"",stage:e.stage,expectedCTC:e.expectedCTC||"",notes:e.notes||"",interviewDate:e.interviewDate?new Date(e.interviewDate).toISOString().split("T")[0]:""}),E(e.id),b(!0)},T=async(e,t)=>{await i.Z.put("/candidates/".concat(e,"/stage"),{stage:t}),M()},P=async e=>{if(confirm("Convert this candidate to an employee?")){Z(e);try{let t=await i.Z.post("/candidates/".concat(e,"/hire"));alert("✅ Employee created! ID: ".concat(t.data.employee.employeeId)),M()}catch(l){var t,a,s,n;let e=(null===(a=l.response)||void 0===a?void 0:null===(t=a.data)||void 0===t?void 0:t.message)||(null===(n=l.response)||void 0===n?void 0:null===(s=n.data)||void 0===s?void 0:s.error)||l.message||"Hiring failed";alert("❌ ".concat(e))}finally{Z(null)}}},R=async e=>{confirm("Delete this candidate?")&&(await i.Z.delete("/candidates/".concat(e)),M())},z=(e,t)=>j(a=>({...a,[e]:t})),I=h.reduce((t,a)=>(t[a]=e.filter(e=>e.stage===a).length,t),{}),H=a?e:e.filter(e=>"HIRED"!==e.stage&&"REJECTED"!==e.stage);return(0,s.jsxs)(n.Z,{title:"Candidates",children:[(0,s.jsxs)("div",{className:"flex flex-wrap items-start justify-between gap-4 mb-5",children:[(0,s.jsxs)("div",{children:[(0,s.jsx)("h2",{className:"page-title",children:"Recruitment Pipeline"}),(0,s.jsxs)("p",{className:"page-sub",children:[H.length," active candidates total"]})]}),(0,s.jsx)("div",{className:"flex items-center gap-3",children:(0,s.jsxs)("button",{className:"flex items-center gap-1.5 px-4 py-2 rounded-xl bg-navy text-white font-semibold text-sm hover:bg-navy/90 shadow-md transition-all",onClick:()=>{j({...p}),E(null),b(!0)},children:[(0,s.jsx)(r.Z,{size:16}),(0,s.jsx)("span",{children:"Add Candidate"})]})})]}),(0,s.jsxs)("div",{className:"flex gap-2 overflow-x-auto pb-4 mb-6 scrollbar-hide",children:[(0,s.jsx)("button",{onClick:()=>m(""),className:"px-4 py-2 rounded-xl text-xs font-bold transition-all border-2 ".concat(a?"border-slate-100 bg-white text-slate-500 hover:border-slate-200":"border-navy bg-navy text-white"),children:"All Active"}),h.map(e=>(0,s.jsxs)("button",{onClick:()=>m(e),className:"px-4 py-2 rounded-xl text-xs font-bold transition-all border-2 whitespace-nowrap flex items-center gap-2 ".concat(a===e?"border-navy bg-navy text-white":"border-slate-100 bg-white text-slate-500 hover:border-slate-200"),children:[e.replace("_"," "),(0,s.jsx)("span",{className:"px-1.5 py-0.5 rounded-full text-[9px] ".concat(a===e?"bg-white/20 text-white":"bg-slate-100 text-slate-400"),children:I[e]||0})]},e))]}),(0,s.jsx)("div",{className:"card mb-6",children:(0,s.jsx)("div",{className:"flex items-center gap-3 px-4 py-3",children:(0,s.jsx)("input",{className:"flex-1 bg-transparent border-none text-sm focus:ring-0 placeholder:text-slate-300",placeholder:"Search candidates by name, email or position...",value:y,onChange:e=>v(e.target.value)})})}),(0,s.jsx)("div",{className:"card overflow-hidden",children:(0,s.jsxs)("table",{className:"table",children:[(0,s.jsx)("thead",{children:(0,s.jsxs)("tr",{children:[(0,s.jsx)("th",{className:"th",children:"Candidate"}),(0,s.jsx)("th",{className:"th",children:"Position"}),(0,s.jsx)("th",{className:"th",children:"Department"}),(0,s.jsx)("th",{className:"th",children:"Expected CTC"}),(0,s.jsx)("th",{className:"th",children:"Status"}),(0,s.jsx)("th",{className:"th",children:"Workflow"}),(0,s.jsx)("th",{className:"th",children:"Actions"})]})}),(0,s.jsx)("tbody",{children:0===H.length?(0,s.jsx)("tr",{children:(0,s.jsx)("td",{colSpan:7,className:"td text-center py-10 text-slate-400",children:"No candidates found"})}):H.map(e=>{var t;return(0,s.jsxs)("tr",{className:"tr",children:[(0,s.jsx)("td",{className:"td",children:(0,s.jsxs)("div",{className:"flex items-center gap-3",children:[(0,s.jsx)("div",{className:"w-9 h-9 rounded-full bg-navy/10 text-navy flex items-center justify-center font-bold text-sm",children:null===(t=e.name.replace(/^(Mr\.|Ms\.|Mrs\.|Dr\.|Mr|Ms|Mrs|Dr) /i,"")[0])||void 0===t?void 0:t.toUpperCase()}),(0,s.jsxs)("div",{children:[(0,s.jsx)("div",{className:"font-semibold",children:e.name.replace(/^(Mr\.|Ms\.|Mrs\.|Dr\.|Mr|Ms|Mrs|Dr) /i,"")}),(0,s.jsx)("div",{className:"text-xs text-slate-400",children:e.email})]})]})}),(0,s.jsx)("td",{className:"td",children:e.position}),(0,s.jsx)("td",{className:"td text-slate-500",children:e.department||"—"}),(0,s.jsx)("td",{className:"td",children:e.expectedCTC?"₹".concat(Number(e.expectedCTC).toLocaleString("en-IN")):"—"}),(0,s.jsx)("td",{className:"td",children:(0,s.jsx)("span",{className:"badge ".concat(x[e.stage]),children:e.stage.replace("_"," ")})}),(0,s.jsx)("td",{className:"td",children:(0,s.jsx)("select",{className:"select !w-32 text-xs",value:e.stage,onChange:t=>T(e.id,t.target.value),children:h.map(e=>(0,s.jsx)("option",{value:e,children:e.replace("_"," ")},e))})}),(0,s.jsx)("td",{className:"td",children:(0,s.jsxs)("div",{className:"flex gap-1",children:[["OFFER_SENT","OFFER_ACCEPTED","ONBOARDING"].includes(e.stage)&&(0,s.jsxs)("button",{onClick:()=>P(e.id),disabled:C===e.id,className:"btn-success btn-sm flex items-center gap-1",title:"Convert to Employee",children:[(0,s.jsx)(c.Z,{size:13})," Hire"]}),(0,s.jsx)("button",{onClick:()=>S(e),className:"btn-icon text-emerald-400 hover:bg-emerald-50",title:"Preview Candidate",children:(0,s.jsx)(d.Z,{size:14})}),(0,s.jsx)("button",{onClick:()=>S(e),className:"btn-icon text-blue-400 hover:bg-blue-50",title:"Edit Details",children:(0,s.jsx)(o.Z,{size:14})}),(0,s.jsx)("button",{onClick:()=>R(e.id),className:"btn-icon text-red-400 hover:bg-red-50",title:"Delete",children:(0,s.jsx)(u.Z,{size:14})})]})})]},e.id)})})]})}),g&&(0,s.jsx)("div",{className:"modal-overlay",onClick:e=>e.target===e.currentTarget&&b(!1),children:(0,s.jsxs)("div",{className:"modal-box max-w-lg slide-in",children:[(0,s.jsxs)("div",{className:"flex items-center justify-between px-6 py-4 border-b border-cream-dark sticky top-0 bg-white rounded-t-2xl",children:[(0,s.jsx)("h3",{className:"font-bold text-navy",children:w?"Edit Candidate":"Add Candidate"}),(0,s.jsx)("button",{onClick:()=>b(!1),className:"btn-icon",children:(0,s.jsx)(u.Z,{size:18})})]}),(0,s.jsxs)("form",{onSubmit:D,className:"p-6 space-y-4",children:[(0,s.jsxs)("div",{className:"grid grid-cols-2 gap-4",children:[(0,s.jsxs)("div",{className:"col-span-2",children:[(0,s.jsx)("label",{className:"label",children:"Full Name *"}),(0,s.jsx)("input",{className:"input",required:!0,value:f.name,onChange:e=>z("name",e.target.value)})]}),(0,s.jsxs)("div",{children:[(0,s.jsx)("label",{className:"label",children:"Email *"}),(0,s.jsx)("input",{className:"input",type:"email",required:!0,value:f.email,onChange:e=>z("email",e.target.value)})]}),(0,s.jsxs)("div",{children:[(0,s.jsx)("label",{className:"label",children:"Phone"}),(0,s.jsx)("input",{className:"input",value:f.phone,onChange:e=>z("phone",e.target.value)})]}),(0,s.jsxs)("div",{children:[(0,s.jsx)("label",{className:"label",children:"Position Applied *"}),(0,s.jsx)("input",{className:"input",required:!0,value:f.position,onChange:e=>z("position",e.target.value)})]}),(0,s.jsxs)("div",{children:[(0,s.jsx)("label",{className:"label",children:"Department"}),(0,s.jsx)("input",{className:"input",value:f.department,onChange:e=>z("department",e.target.value)})]}),(0,s.jsxs)("div",{children:[(0,s.jsx)("label",{className:"label",children:"Expected CTC (₹/year)"}),(0,s.jsx)("input",{className:"input",type:"number",value:f.expectedCTC,onChange:e=>z("expectedCTC",e.target.value)})]}),(0,s.jsxs)("div",{children:[(0,s.jsx)("label",{className:"label",children:"Interview Date"}),(0,s.jsx)("input",{className:"input",type:"date",value:f.interviewDate,onChange:e=>z("interviewDate",e.target.value)})]}),(0,s.jsxs)("div",{children:[(0,s.jsx)("label",{className:"label",children:"Current Stage"}),(0,s.jsx)("select",{className:"select",value:f.stage,onChange:e=>z("stage",e.target.value),children:h.map(e=>(0,s.jsx)("option",{value:e,children:e.replace("_"," ")},e))})]}),(0,s.jsxs)("div",{className:"col-span-2",children:[(0,s.jsx)("label",{className:"label",children:"Notes"}),(0,s.jsx)("textarea",{className:"textarea",rows:2,value:f.notes,onChange:e=>z("notes",e.target.value)})]})]}),(0,s.jsxs)("div",{className:"flex gap-3 pt-2",children:[(0,s.jsx)("button",{type:"submit",className:"btn-primary flex-1",disabled:N,children:N?"Saving...":w?"Update Candidate":"Add Candidate"}),(0,s.jsx)("button",{type:"button",className:"btn-ghost flex-1",onClick:()=>b(!1),children:"Cancel"})]}),w&&(0,s.jsx)("p",{className:"text-[10px] text-slate-400 text-center italic",children:"Updating these details will allow you to fix conflicting emails before hiring."})]})]})})]})}},43345:function(e,t,a){"use strict";a.d(t,{Z:function(){return s}});/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */let s=(0,a(87461).Z)("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]])},47907:function(e,t,a){"use strict";var s=a(15313);a.o(s,"usePathname")&&a.d(t,{usePathname:function(){return s.usePathname}}),a.o(s,"useRouter")&&a.d(t,{useRouter:function(){return s.useRouter}}),a.o(s,"useSearchParams")&&a.d(t,{useSearchParams:function(){return s.useSearchParams}})}},function(e){e.O(0,[9546,958,394,2971,5468,1744],function(){return e(e.s=45271)}),_N_E=e.O()}]);