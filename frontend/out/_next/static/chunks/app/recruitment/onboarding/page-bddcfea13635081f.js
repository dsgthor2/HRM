(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[939],{17874:function(e,t,a){Promise.resolve().then(a.bind(a,37291))},37291:function(e,t,a){"use strict";a.r(t),a.d(t,{default:function(){return x}});var s=a(3827),n=a(49555),l=a(64090),c=a(10826),i=a(97404),r=a(70094),d=a(57976);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */let o=(0,a(87461).Z)("Circle",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}]]);var h=a(50489);function x(){let[e,t]=(0,l.useState)([]),[a,x]=(0,l.useState)(""),[u,m]=(0,l.useState)([]),[y,p]=(0,l.useState)("");(0,l.useEffect)(()=>{c.Z.get("/employees").then(e=>t(e.data)).catch(()=>{})},[]);let f=e=>{x(e),e?c.Z.get("/onboarding/".concat(e)).then(e=>m(e.data)).catch(()=>{}):m([])},k=async()=>{a&&(await c.Z.post("/onboarding/init/".concat(a)),f(a))},v=async e=>{await c.Z.put("/onboarding/".concat(e.id),{completed:!e.completed}),f(a)},g=async()=>{y.trim()&&a&&(await c.Z.post("/onboarding",{employeeId:a,taskName:y,dueDate:new Date(Date.now()+6048e5)}),p(""),f(a))},j=async e=>{await c.Z.delete("/onboarding/".concat(e)),f(a)},b=u.filter(e=>e.completed).length,N=u.length?Math.round(b/u.length*100):0,Z=e.find(e=>e.id===a);return(0,s.jsxs)(n.Z,{title:"Onboarding",children:[(0,s.jsxs)("div",{className:"mb-5",children:[(0,s.jsx)("h2",{className:"page-title",children:"Employee Onboarding"}),(0,s.jsx)("p",{className:"page-sub",children:"Track new hire onboarding checklist"})]}),(0,s.jsxs)("div",{className:"grid grid-cols-1 lg:grid-cols-3 gap-5",children:[(0,s.jsxs)("div",{className:"space-y-4",children:[(0,s.jsxs)("div",{className:"card",children:[(0,s.jsx)("label",{className:"label",children:"Select Employee"}),(0,s.jsxs)("select",{className:"select",value:a,onChange:e=>f(e.target.value),children:[(0,s.jsx)("option",{value:"",children:"Choose employee"}),e.map(e=>(0,s.jsx)("option",{value:e.id,children:e.name},e.id))]}),Z&&(0,s.jsx)("div",{className:"mt-4 p-3 bg-cream rounded-xl",children:(0,s.jsxs)("div",{className:"flex items-center gap-3",children:[(0,s.jsx)("div",{className:"w-10 h-10 rounded-full bg-navy text-white flex items-center justify-center font-bold",children:Z.name[0]}),(0,s.jsxs)("div",{children:[(0,s.jsx)("div",{className:"font-semibold text-navy text-sm",children:Z.name}),(0,s.jsx)("div",{className:"text-xs text-slate-400",children:Z.designation}),(0,s.jsxs)("div",{className:"text-xs text-slate-400",children:["Joined: ",new Date(Z.joinDate).toLocaleDateString("en-IN")]})]})]})})]}),a&&(0,s.jsx)("div",{className:"card",children:0===u.length?(0,s.jsxs)("div",{className:"text-center py-4",children:[(0,s.jsx)("p",{className:"text-sm text-slate-400 mb-3",children:"No tasks yet"}),(0,s.jsxs)("button",{onClick:k,className:"btn-primary w-full flex items-center justify-center gap-2",children:[(0,s.jsx)(i.Z,{size:15})," Initialize Default Tasks"]})]}):(0,s.jsxs)(s.Fragment,{children:[(0,s.jsxs)("div",{className:"mb-4",children:[(0,s.jsxs)("div",{className:"flex items-center justify-between mb-1.5",children:[(0,s.jsx)("span",{className:"text-xs font-semibold text-slate-500",children:"Overall Progress"}),(0,s.jsxs)("span",{className:"text-xs font-bold text-navy",children:[b,"/",u.length]})]}),(0,s.jsx)("div",{className:"h-2.5 bg-cream-dark rounded-full overflow-hidden",children:(0,s.jsx)("div",{className:"h-full bg-navy rounded-full transition-all duration-500",style:{width:"".concat(N,"%")}})}),(0,s.jsx)("div",{className:"text-center mt-1.5",children:(0,s.jsxs)("span",{className:"text-sm font-black ".concat(100===N?"text-emerald-600":"text-navy"),children:[N,"% ",100===N?"✅ Complete!":"complete"]})})]}),(0,s.jsxs)("button",{onClick:k,className:"btn-ghost w-full btn-sm",children:[(0,s.jsx)(i.Z,{size:13})," Reset to Defaults"]})]})}),a&&(0,s.jsxs)("div",{className:"card",children:[(0,s.jsx)("label",{className:"label",children:"Add Custom Task"}),(0,s.jsxs)("div",{className:"flex gap-2",children:[(0,s.jsx)("input",{className:"input",placeholder:"Task name...",value:y,onChange:e=>p(e.target.value),onKeyDown:e=>"Enter"===e.key&&g()}),(0,s.jsx)("button",{className:"btn-primary px-3",onClick:g,children:(0,s.jsx)(r.Z,{size:15})})]})]})]}),(0,s.jsx)("div",{className:"col-span-2",children:a?0===u.length?(0,s.jsx)("div",{className:"card flex flex-col items-center justify-center h-64 text-slate-400",children:(0,s.jsx)("p",{className:"text-sm",children:'Click "Initialize Default Tasks" to get started'})}):(0,s.jsxs)("div",{className:"card",children:[(0,s.jsxs)("h3",{className:"font-bold text-navy mb-4 flex items-center gap-2",children:["Onboarding Checklist",(0,s.jsxs)("span",{className:"badge badge-navy text-xs",children:[u.length," tasks"]})]}),(0,s.jsx)("div",{className:"space-y-2",children:u.map(e=>(0,s.jsxs)("div",{className:"flex items-center gap-3 p-3.5 rounded-xl border-2 transition-all cursor-pointer group\n                      ".concat(e.completed?"bg-emerald-50 border-emerald-200":"bg-cream border-transparent hover:border-cream-border"),onClick:()=>v(e),children:[(0,s.jsx)("div",{className:"flex-shrink-0",children:e.completed?(0,s.jsx)(d.Z,{size:20,className:"text-emerald-600"}):(0,s.jsx)(o,{size:20,className:"text-slate-300 group-hover:text-slate-400"})}),(0,s.jsx)("span",{className:"flex-1 text-sm font-medium ".concat(e.completed?"line-through text-slate-400":"text-navy"),children:e.taskName}),e.completedAt&&(0,s.jsxs)("span",{className:"text-[10px] text-emerald-600 font-semibold flex-shrink-0",children:["✓ ",new Date(e.completedAt).toLocaleDateString("en-IN")]}),e.dueDate&&!e.completed&&(0,s.jsxs)("span",{className:"text-[10px] text-slate-400 flex-shrink-0",children:["Due: ",new Date(e.dueDate).toLocaleDateString("en-IN")]}),(0,s.jsx)("button",{onClick:t=>{t.stopPropagation(),j(e.id)},className:"opacity-0 group-hover:opacity-100 btn-icon text-red-400 hover:bg-red-50 ml-1 flex-shrink-0",title:"Remove task",children:(0,s.jsx)(h.Z,{size:13})})]},e.id))})]}):(0,s.jsxs)("div",{className:"card flex flex-col items-center justify-center h-64 text-slate-400",children:[(0,s.jsx)(d.Z,{size:48,className:"mb-3 opacity-20"}),(0,s.jsx)("p",{className:"text-sm",children:"Select an employee to manage onboarding"})]})})]})]})}},43345:function(e,t,a){"use strict";a.d(t,{Z:function(){return s}});/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */let s=(0,a(87461).Z)("ShieldCheck",[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]])},50489:function(e,t,a){"use strict";a.d(t,{Z:function(){return s}});/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */let s=(0,a(87461).Z)("Zap",[["polygon",{points:"13 2 3 14 12 14 11 22 21 10 12 10 13 2",key:"45s27k"}]])}},function(e){e.O(0,[29,852,555,971,69,744],function(){return e(e.s=17874)}),_N_E=e.O()}]);